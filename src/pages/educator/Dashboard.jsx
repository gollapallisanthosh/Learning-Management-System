...
const Dashboard = () => {
  ...
  const [dashboardData, setDashboardDta] = useState(null)

  const fetchDashboardData = async () => {
    setDashboardDta(dummyDashboardData)
  }
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 pt-4 pt-8 pb-0'>
